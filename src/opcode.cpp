...
std::map<uint16_t, Handler> one_handler_map{
  ...
  {0xE9, jmpE9},     {0xF5, cmc},       {0xF8, clc},       {0xF9, stc},
  {0xFE, extFE},     {0xFF, extFF},     {0x8F, ext8F},     {0xF6, extF6},
  {0xF7, extF7},     {0x86, xchg86_87}, {0x87, xchg86_87}, {0x91, xchg9x},
  {0x92, xchg9x},    {0x93, xchg9x},    {0x94, xchg9x},    {0x95, xchg9x},
  {0x96, xchg9x},    {0x97, xchg9x},    {0xD0, shiftD0},   {0xD1, shiftD1},
  {0xD3, shiftD3},   {0xC0, shiftC0},   {0xC1, shiftC1},   {0x8D, lea8D},
  {0x24, and24},     {0x25, and25},     {0x20, and20},     {0x21, and21},
  {0x22, and22},     {0x23, and23},     {0x0C, or0C},      {0x0D, or0D},
  {0x08, or08},      {0x09, or09},      {0x0A, or0A},      {0x0B, or0B},
  {0x34, xor34},     {0x35, xor35},     {0x30, xor30},     {0x31, xor31},
  {0x32, xor32},     {0x33, xor33}};
