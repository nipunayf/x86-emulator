...
std::map<uint16_t, Handler> one_handler_map{
  ...
  {0x6A, push6A},    {0x68, push68},    {0x72, jc72},      {0x90, nop90},
  ...
  {0x1F, pop1F},     {0x07, pop07},     {0x17, pop17},     {0x88, mov88},
  {0x89, mov89},     {0x8A, mov8A},     {0x8B, mov8B},     {73, jae73},
  {0x74, je74},      {0x76, jbe76},     {0x77, ja77},      {0x7C, jl7C},
  {0x7D, jge7D},     {0x7F, jg7F},      {0xE3, jecxzE3},   {0x8C, mov8C},
  {0x8E, mov8E},     {0xA0, movA0_A1},  {0xA1, movA0_A1},  {0xA2, movA2_A3},
  {0xA3, movA2_A3},  {0xB0, movBx},     {0xB1, movBx},     {0xB2, movBx},
  {0xB3, movBx},     {0xB4, movBx},     {0xB5, movBx},     {0xB6, movBx},
  {0xB7, movBx},     {0xB8, movBx},     {0xB9, movBx},     {0xBA, movBx},
  {0xBB, movBx},     {0xBC, movBx},     {0xBD, movBx},     {0xBE, movBx},
  {0xBF, movBx},     {0xC6, movCx},     {0xC7, movCx},     {0x3C, cmp3C},
  {0x3D, cmp3D},     {0x38, cmp38},     {0x39, cmp39},     {0x3A, cmp3A},
  {0x3B, cmp3B},     {0xA8, testA8_A9}, {0xA9, testA8_A9}, {0x84, test84_85},
  {0x85, test84_85}, {0x80, ext80},     {0x81, ext81},     {0x83, ext83},
  {0xEB, jmpEB},     {0xE9, jmpE9},     {0xF5, cmc},       {0xF8, clc},
  {0xF9, stc},       {0xFE, extFE},     {0xFF, extFF},     {0x8F, ext8F},
  {0xF6, extF6},     {0xF7, extF7},     {0x86, xchg86_87}, {0x87, xchg86_87},
  {0x91, xchg9x},    {0x92, xchg9x},    {0x93, xchg9x},    {0x94, xchg9x},
  {0x95, xchg9x},    {0x96, xchg9x},    {0x97, xchg9x},    {0xD0, shiftD0},
  {0xD1, shiftD1},   {0xD3, shiftD3},   {0xC0, shiftC0},   {0xC1, shiftC1},
  {0x8D, lea8D},     {0x24, and24},     {0x25, and25},     {0x20, and20},
  {0x21, and21},     {0x22, and22},     {0x23, and23},     {0x0C, or0C},
  {0x0D, or0D},      {0x08, or08},      {0x09, or09},      {0x0A, or0A},
  {0x0B, or0B},      {0x34, xor34},     {0x35, xor35},     {0x30, xor30},
  {0x31, xor31},     {0x32, xor32},     {0x33, xor33}};
