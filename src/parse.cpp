...
std::map<uint16_t, Handler> one_handler_map{
  ...
  {0x74, je74},      {0x75, jne75},     {0x76, jbe76},     {0x77, ja77},
  {0x7C, jl7C},      {0x7D, jge7D},     {0x7E, jle7E},     {0x7F, jg7F},
  {0xE3, jecxzE3},   {0x8C, mov8C},     {0x8E, mov8E},     {0xA0, movA0_A1},
  ...
  {0xC7, movCx},     {0x3C, cmp3C},     {0x3D, cmp3D},     {0x38, cmp38},
  {0x39, cmp39},     {0x3A, cmp3A},     {0x3B, cmp3B},     {0xA8, testA8_A9},
  {0xA9, testA8_A9}, {0x84, test84_85}, {0x85, test84_85}, {0x80, ext80},
  {0x81, ext81},     {0x83, ext83},     {0xEB, jmpEB},     {0xE9, jmpE9},
  {0xF5, cmc},       {0xF6, extF6},     {0xF7, extF7},     {0xF8, clc},
